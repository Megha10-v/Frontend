...
function Terms() {
    return (
      ...
      <h3>2A. Prohibited Items Policy</h3>
      ...
      <h3>2B. Ad/Banners Posting, information, Advertisement</h3>
      <ul>
      ...
      <h3>2C. In addition to the above and for the purposes of clarity, all Users shall be expected to adhere to and comply with the following Policies while listing items.</h3>
      <ul>
      ...
      <p>Users who violate the prohibited items policy and or the restricted items policy may be subject to the following actions:</p>
      <ul>
      ...
      <p>ELK offers several value-added services for users who want to promote their products or services to gain special attention from viewers and receive more business inquiries. These services are optional, and ELK never pressures any user to utilize them at any time.</p>
      <p>ELK reserves the complete rights to edit, modify, remove or introduce new value-added services in the future.</p>

      <h3>4A. Prosper ID</h3>
      <p>On successful login, the System will allot an Alpha Numeric ID (e.g., AB1234) which will be issued to you without rental cost.</p>
      <ul>
      ...
      <p>ELK may provide, on its site, links to sites operated by other entities. If the user decides to view this site, they shall do so at their own risk, subject to that site’s terms and conditions of use and privacy policy that may be different from those of this site. It is the user’s responsibility to take all protective measures to guard against viruses or other destructive elements they may encounter on these sites. ELK makes no warranty or representation regarding and does not endorse any linked website or the information appearing thereon or any of the products or services described thereon.</p>
      ...
      <p>ELK is not liable for any infringement of intellectual property rights arising out of Products & Services posted on the site by end-users or any other third parties. If you are an owner of intellectual property rights or an agent who is fully authorized to act on behalf of the owner of intellectual property rights and believe that any Content or other content infringes upon your intellectual property right or intellectual property right of the owner on whose behalf you are authorized to act, you may write to us at support@ELK.in to delete the relevant Content in good faith.</p>

      <h2>18. Cautions & Disclaimers</h2>
      <p>We strongly recommend our users exercise their discretion & due diligence about all relevant aspects prior to availing of any products/services. Please note that ELK does not implicitly or explicitly endorse any product/s or services provided by advertisers/service providers.</p>
      <p>Service providers at all times ensure that all the applicable laws that govern their profession are followed while rendering their services.</p>
      <p>We strongly advise the users to upload the images of their original product and their own images while posting Ads of Rental Products and Freelancing Services respectively. However, ELK shall not be responsible for third-party images downloaded or used by the users while posting their Ads. ELK also reserves the right to edit/update/correct/delete/add watermarks on any images uploaded by the users.</p>
      <p>The information related to the name, address, contact details of the business establishments has been verified as existing at the time of verification of any advertiser with ELK. This verification is solely based on the documents as supplied by an advertiser/s or as per the details contained in the User verification page.</p>
      <p>We strongly recommend our users exercise their discretion & due diligence about all relevant aspects before availing of any products/services. Please note that ELK does not implicitly or explicitly endorse any product/s or services provided by advertisers/service providers.</p>
      <p>ELK is not responsible for any disputes arising due to fraudulent activities, deceptive/misleading misbehavior, or cheating by the other User, and ELK is nowhere responsible for any of these consequences. However, Users can escalate to support@ELK.in to complain about the particular Post/User, and ELK reserves the sole authority to take action in favor of the same.</p>

      <h2>19. Miscellaneous</h2>
      <p>If all premium ads available to the advertiser under the subscription scheme are not used/availed of during the period of these terms, the unutilized units shall be forfeited - no refund shall be made, and neither can the unutilized credits be carried forward.</p>
      <p>The banner shall be dynamically created by Users from their dashboard. Banner hoisting is a paid service and the banners will be displayed on a rotational basis. ELK reserves the right to approve/Reject the banner and ELK retains the rights of allotting “N no of banners on the particular time slot on user preferred destination cities. ELK does not provide any guarantees of impressions or clicks on the banners.</p>
      ...
      <p>The advertiser acknowledges that any liability/claim in respect of the products or services promoted through the Banners/Advertisements under the scope of this Agreement shall be solely to the account of the advertiser. It is agreed that in case of any claims in respect of the same against ELK, the advertiser shall indemnify ELK against all such claims and damages.</p>
      <p>Advertiser shall procure and keep valid all necessary licenses, permissions, authorizations, consents, approvals, and registrations with/from any government department, agency, or authority required for it to perform the Services in accordance with this Agreement and bear sole and exclusive responsibility for all compliances with such licenses, permissions, authorizations, consents, approvals, and registrations.</p>
    </div>
    </div>
