...
// import { useGetAdsLocationListQuery, useGetAdsListQuery, useDeleteAdMutation } from "../../store/services/superadmin.service";
...
function SuperAdminHome() {
  ...
  const { data: adsData, isLoading: adsLoading } = useGetAdsListQuery(
    { date: selectedDate, location: selectedLocation },
  ...
  const adLocations = ["Select", "New Delhi", ...(locationsData?.list ?? [])];
                          ...
                          <div className="ad-slider">
                            ...
                            {ad.ad_images.length > 1 && (
                              <>
                                <button
                                  className="nav-btn left"
                                  onClick={() => slideImage(ad.id, "left", ad.ad_images.length)}
                                >
                                  ‹
                                </button>
                                <button
                                  className="nav-btn right"
                                  onClick={() => slideImage(ad.id, "right", ad.ad_images.length)}
                                >
                                  ›
                                </button>
                              </>
